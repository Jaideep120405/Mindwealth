...
df = pd.read_excel("aaii_data_2.xls")
...
# Find the top 10 percentile values
top_10_percentile = df2['Spread'].quantile(0.1)

# Identify and plot the top 10 percentile elements with red dots
...
print(percentileofscore(new12, 0))
